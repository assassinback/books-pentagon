...
if (array_key_exists('data', $result) && array_key_exists('status', $result['data']) && ($result['data']['status'] === 'success')) {
    ...
    $query='INSERT into papersbought(buyerID,sellerID,paperName,paperDescription,paperPrice) VALUES("'.$_COOKIE["id"].'","'.$_COOKIE["sellerID"].'","'.$_COOKIE["paperName"].'","'.$_COOKIE["paperDescription"].'","'.$_COOKIE["paperPrice"].'")';
