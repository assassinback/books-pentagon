...
//   }   
// }
 $query='INSERT INTO userinfo(username,`password`,`dateofbirth`,`email`) VALUES("'.$_POST["username"].'","'.$_POST["password"].'","'.$_POST["dateofbirth"].'","'.$_POST["email"].'")';
 ...
 if(mysqli_query($con,$query)){
    ...
    setcookie("username",$name,time()+2419200);
    setcookie("password",$password,time()+2419200);
