...
<head>
    ...
    <title>BooksPentagon  -  Search Paper</title>
...
include("header.php");
    ...
    <th>Price</th>
    <th>Buy Papers</th>';
    $query='SELECT * from publishedpapers where paperName like "%'.$_POST["bookname"].'%"';
    ...
    if($rs=mysqli_query($con,$query))
    {
        while($row=mysqli_fetch_array($rs))
        {
            ...
            if(isset($_COOKIE["username"])&&isset($_COOKIE["password"]))
            {
                echo '<td>
                    <form method="POST">
                        <input type="submit" name="buythis" value="Buy Paper">
                        ...
                        <input type="hidden" name="paperPrice" value="'.$row["paperPrice"].'">
                    </form>
                    </td>';
            }
            else
            {
                echo '<td><a href="userLogin.php">Login?</a></td>';
            }
            echo '</tr>';
        }
    }
